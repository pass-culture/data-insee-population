...
| COM 2022 POP1B | [8581812](https://www.insee.fr/fr/statistiques/8581812) | Saint-Pierre-et-Miquelon (975), Saint-Barthélemy (977), Saint-Martin (978) age pyramids by sex (aged forward) |
...
2. **Add overseas territories not in INDCVI.** INDCVI covers métropole
   ...
   - **Saint-Pierre-et-Miquelon (975), Saint-Barthélemy (977),
     Saint-Martin (978)** from POP1B 2022 (one `C.O.M.` workbook, one
